...
\label{balanced}
\end{subfigure}
\caption[Example of unbalanced (\ref{unbalanced}) and balanced (\ref{balanced}) tree.]{Example of unbalanced (\ref{unbalanced}) and balanced (\ref{balanced}) tree. Credits: \href{https://en.wikipedia.org/wiki/Self-balancing_binary_search_tree}{Self-balancing binary search tree, Wikipedia}}
\label{trees_19}
\end{figure}
