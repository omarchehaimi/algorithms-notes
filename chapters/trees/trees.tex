...
\draw node[draw=none, rectangle, below=1mm of nd] {a, b, d, e, c, f};
  ...
  \draw[->, >=stealth', blue, rounded corners, dashed, line width=0.7pt]
    ($(na) + (-0.4,0.2)$) --
    ($(nb) + (-0.4,0.2)$) --
    %($(nb) + (-0.44,0.0)$) --
    ($(nd) + (-0.50,0.0)$) --
...
\node (na){$a$}
   child{node (nb) {$b$}
             child {node (nd) {$d$}
				child{node[red] (ng) {$g$} edge from parent[red]}
				child{node[red] (nh) {$h$} edge from parent[red]}             
             }
             child {node (ne) {$e$}
             	child{node[red] (ni) {$i$} edge from parent[red]}
				child{node[red] (nj) {$j$} edge from parent[red]}
             }
        }
   child{node (nc) {$c$}
			child[missing]
...
\draw[red, style={-}] ($(nb) + (0.5,0.5)$) -- ($(nb) + (-0.5,-0.5)$);
\draw[red, style={-}] ($(nb) + (-0.5,0.5)$) -- ($(nb) + (0.5,-0.5)$);

\draw[red, style={-}] ($(nc) + (0.5,0.5)$) -- ($(nc) + (-0.5,-0.5)$);
\draw[red, style={-}] ($(nc) + (-0.5,0.5)$) -- ($(nc) + (0.5,-0.5)$);

\path[->, red] (nf.north east) edge [bend right=60] node[draw=none, xshift=24pt] {Case 1} (nc.east);
\path[->, red] (ne.north east) edge [bend right=60] node[draw=none, xshift=24pt] {Case 2} (nb.east);
\path[->, red] (ng.north west) edge [bend left=100] node[draw=none, xshift=-22pt] {Case 3} (nb.west);
...
\node (na){$a$}
   ...
   child{node (nc) {$c$} edge from parent[->, >=stealth']
			child{node[red] (ng) {$g$} edge from parent[red, ->, >=stealth']}
			child{node (nf) {$f$} edge from parent[->, >=stealth']}
		};

\draw[red, style={-}, dashed] 
	($(na) + (0.5,0.5)$) -- 
	($(na) + (-0.5,0.5)$) --
	($(na) + (-0.5,-0.5)$) --
	($(na) + (0.5,-0.5)$) --
...
\draw ($(nh) + (1,0)$) node[draw=none, red, minimum size=2mm, style={-}] {$1$};
...
\node[red] (n5){$5$}
   ...
   child{node[red] (n8) {$8$} edge from parent[->, >=stealth']
			child{node[red] (n7) {$7$} edge from parent[->, >=stealth']}
			child{node (n10) {$10$} edge from parent[->, >=stealth']}
		};

\draw ($(n5) + (0.6, 0.6)$) node[draw=none, rectangle] {\textcolor{red}{5<7}};
\draw ($(n8) + (0.6, 0.6)$) node[draw=none, rectangle] {\textcolor{red}{8>7}};
\draw ($(n7) + (-0.5, 0.6)$) node[draw=none, rectangle] {\textcolor{red}{7=7}};
...
\node[red] (n5){$5$}
   child{node[red] (n3) {$3$} edge from parent[->, >=stealth']
             child {node (n1) {$1$} edge from parent[->, >=stealth']}
			 child {node[red] (n4) {$4$} edge from parent[->, >=stealth']}
        }
...
\draw ($(n5) + (-0.6, 0.6)$) node[draw=none, rectangle] {\textcolor{red}{5<7}};
\draw ($(n3) + (-0.6, 0.6)$) node[draw=none, rectangle] {\textcolor{red}{8>7}};
...
\draw ($(n30) + (2, 0)$) node[draw=none, rectangle] {\textcolor{red}{30>21 no swap}};
\draw ($(n21) + (2, 0)$) node[draw=none, rectangle] {\textcolor{red}{20<21 swap}};

\path[->, red] (n20.east) edge [bend right=60] node[draw=none, xshift=24pt] {} (n21.east);
\path[->, red] (n21.south) edge [bend right=60] node[draw=none, xshift=24pt] {} (n20.west);
\end{tikzpicture}
\caption[Add a new node to a heap.]{Add a new node to a heap.}
\label{trees_17}
\end{figure}
...
\matrix (m1) at ($(n2) + (0, -1)$) [matrix of nodes, nodes={draw, minimum size=8mm},
    column sep=-\pgflinewidth] { \node[rectangle, align=center]{a}; \\ \node[rectangle, align=center]{b}; \\};
