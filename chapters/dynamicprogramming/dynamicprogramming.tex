...
$v_{1}=2$, $w_{1}=3$ & $1$ & $0$ & $0$ & $0$ & $2$ & $2$ & $2$ & $2$ & $2$ \\
$v_{2}=2$, $w_{2}=1$ & $2$ & $0$ & $2$ & $2$ & $2$ & $4$ & $4$ & $4$ & $4$ \\
$v_{3}=4$, $w_{3}=3$ & $3$ & $0$ & $2$ & $2$ & $4$ & $6$ & $6$ & $6$ & $8$ \\
$v_{4}=5$, $w_{4}=4$ & $4$ & $0$ & $2$ & $2$ & $4$ & $6$ & $7$ & $7$ & $9$ \\
$v_{5}=3$, $w_{5}=2$ & $5$ & $0$ & $2$ & $3$ & $5$ & $6$ & $7$ & $9$ & $10$ \\
};
...
\draw[->, >=stealth] (mat-7-3.center) -- (mat-6-3.center);
\draw[->, >=stealth] (mat-7-4.center) -- (mat-6-4.center);
\draw[->, >=stealth] (mat-7-5.center) -- (mat-6-5.center);
\draw[->, >=stealth] (mat-7-6.center) -- (mat-6-6.center);
\draw[->, >=stealth, ForestGreen] (mat-7-6.center) -- (mat-6-3.center);
\draw[->, >=stealth] (mat-7-7.center) -- (mat-6-7.center);
\draw[->, >=stealth, ForestGreen] (mat-7-7.center) -- (mat-6-4.center);
\draw[->, >=stealth] (mat-7-8.center) -- (mat-6-8.center);
\draw[->, >=stealth, ForestGreen] (mat-7-8.center) -- (mat-6-5.center);
\draw[->, >=stealth] (mat-7-9.center) -- (mat-6-9.center);
\draw[->, >=stealth, ForestGreen] (mat-7-9.center) -- (mat-6-6.center);
\draw[->, >=stealth] (mat-7-10.center) -- (mat-6-10.center);
\draw[->, >=stealth, ForestGreen] (mat-7-10.center) -- (mat-6-7.center);
\end{scope}
\end{tikzpicture}
