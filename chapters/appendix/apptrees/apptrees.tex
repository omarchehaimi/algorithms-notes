...
\draw ($(na) + (3.5, 0.4)$) node[draw=none, rectangle, align=left] (stack) {Stack};
\draw ($(stack) + (3.5, 0)$) node[draw=none, rectangle, align=left] (visited) {Visited};

\draw ($(stack.west) + (-3mm, -8mm)$) node[draw=none, rectangle, align=left] (stack1) {1)};
\draw[-] ($(stack.west) + (0,-4mm)$) -- ($(stack.west) + (10mm,-4mm)$);
\draw[-] ($(stack.west) + (0,-12mm)$) -- ($(stack.west) + (10mm,-12mm)$);
