...
\begin{figure}[H]
\centering
\begin{tikzpicture}[draw, minimum width=4cm, minimum height=0.5cm, thick]  
    ...
    \matrix [matrix of nodes, nodes={draw, nodes={draw}}, nodes in empty cells, row sep=-\pgflinewidth] (tab2) at ($(tab1) + (7.6,0)$)
    {
      6 -> 0123456 \\ 
      7 -> 6543217 \\
      ... \qquad ... \\
    ...
    \matrix [matrix of nodes, nodes={draw, nodes={draw}}, nodes in empty cells, row sep=-\pgflinewidth] (tab4) at ($(tab3) + (7.6,0)$)
    {
      6 -> 0123456 \\ 
      6 -> 6543216 \\
    };
    ...
    \matrix [matrix of nodes, nodes={draw, nodes={draw}}, nodes in empty cells, row sep=-\pgflinewidth, minimum width=0.5cm, minimum height=0.5cm] (tab5) at ($(tab3) + (2.6,-2)$)
    {
      6 & 0123456 & 6543216 & & \\
    };
\end{tikzpicture}
