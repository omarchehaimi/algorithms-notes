...
\draw[draw,<-,>=latex, green](1)--(32:9mm)node[right,inner sep=0]{\textcolor{black}{Node}};
\draw[draw,<-,>=latex, green](-1.02,-1.8)--(-0.4,-1.8)node[right,inner sep=0]{\textcolor{black}{Edge}};
		\draw (1) -- (2);
		\draw (1) -- (3);
		\draw (2) -- (3);
		\draw (3) -- (5);
