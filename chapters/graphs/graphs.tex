...
\draw[draw,<-,>=latex, ForestGreen](1)--(32:9mm)node[right,inner sep=0]{\textcolor{black}{Node}};
\draw[draw,<-,>=latex, ForestGreen](-1.02,-1.8)--(-0.4,-1.8)node[right,inner sep=0]{\textcolor{black}{Edge}};
		\draw (1) -- (2);
		\draw (1) -- (3);
		\draw (2) -- (3);
		\draw (3) -- (5);
...
\begin{tikzpicture}[node distance={15mm}, thick, main/.style = {draw, circle, minimum size=8mm}]
	...
	\label{noneuler}
\end{subfigure}
\caption[Eulerian path (\ref{euler}) and not Eulerian path (\ref{noneuler}).]{Eulerian path (\ref{euler}) and not Eulerian path (\ref{noneuler}).}
\label{graphs_8}
\end{figure}
...
\begin{tikzpicture} [node distance={15mm}, thick, main/.style = {draw, circle, minimum size=8mm}]  
  ...
  \draw[->, >=stealth', ForestGreen] (nb) edge node[draw=none, xshift=6pt, yshift=10pt] {\textcolor{ForestGreen}{1}} (nd);
  \draw[->, >=stealth', ForestGreen] (nd) edge node[draw=none, xshift=4pt] {\textcolor{ForestGreen}{2}} (na);
  \draw[->, >=stealth', ForestGreen] (na) edge node[draw=none, xshift=-6pt, yshift=10pt] {\textcolor{ForestGreen}{3}} (nc);
...
\begin{table}[H]
	...
	\begin{tikzpicture}[overlay, remember picture]
		\draw [->, line width=0.3mm] ({pic cs:b}) -- ({pic cs:a});
		\draw [->, line width=0.3mm] ({pic cs:cc}) -- ({pic cs:bb});
		\draw [->, line width=0.3mm] ({pic cs:d}) -- ({pic cs:c});
	\end{tikzpicture}
\end{table}
