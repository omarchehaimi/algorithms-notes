\chapter{Graphs}
\label{chp:graphs}
In this chapter are introduced the fundamental concepts of \textbf{graphs} as a mathematical object, and as an abstract data type, its applications to computer science, and the most important and notable algorithms with their implementations. 
...
In graphs, differently to trees, closed loops can exist. These kind of closed loops can be dangerous for the algorithms since they could lead to infinite executions.
