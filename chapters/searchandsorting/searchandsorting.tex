...
\section{Quicksort}
The \textbf{quicksort} is a sorting algorithm of the divide et impera class. It works by randomly choosing an element of the array, called pivot, and putting all the bigger and lower values on its right and on its left respectively. This procedure is repeated recursively on the two new subarrays until all the elements have been a pivot \cite{wikiqicksort}. 
