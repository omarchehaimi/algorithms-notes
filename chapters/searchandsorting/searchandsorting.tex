...
\begin{figure}[H]
\centering
\begin{tikzpicture}[array/.style={matrix of nodes,nodes={draw, minimum size=7mm},column sep=-\pgflinewidth, row sep=0.5mm, nodes in empty cells}, thick]
...
\draw ($(array1-2-7.east) + (12mm,0)$) node[draw=none, rectangle, align=left, minimum size=7mm] {M'=M+-1};

\draw[decorate, decoration={brace, amplitude=3pt, mirror}] 
    ($(array1-2-1.west) + (0, -4mm)$) coordinate (array1-2-1.west) -- ($(array1-2-4.east) + (0, -4mm)$) coordinate (array1-2-4.east);
\draw[decorate, decoration={brace, amplitude=3pt, mirror}] 
    ($(array1-2-5.west) + (0, -4mm)$) coordinate (array1-2-1.west) -- ($(array1-2-7.east) + (0, -4mm)$) coordinate (array1-2-4.east);
\draw ($(array1-2-4.south) + (-11.5mm,-3mm)$) node[draw=none, rectangle, align=left, minimum size=7mm] (left) {left};
\draw ($(array1-2-4.south) + (14mm,-3.5mm)$) node[draw=none, rectangle, align=left, minimum size=7mm] (right) {right};
...
\draw ($(array21-2-2.south east) + (-7mm,-3.5mm)$) node[draw=none, rectangle, align=left, minimum size=7mm] {i};
\draw ($(array22-2-2.south) + (-6mm,-3.5mm)$) node[draw=none, rectangle, align=left, minimum size=7mm] {j};
\draw[->,  >=stealth] ($(array21-2-1.west) + (0, -7mm)$) -- ($(array21-2-1.east) + (0, -7mm)$);
\draw[->,  >=stealth] ($(array22-2-1.west) + (0, -7mm)$) -- ($(array22-2-1.east) + (0, -7mm)$);

\draw ($(array1-2-4.south) + (0,-30mm)$) node[draw=none, rectangle, align=left, minimum size=7mm] (comp) {left[i]<right[j]};
\end{tikzpicture}
